...
let changableVar = 'Hasib';
const notChangableVar = 'Marzia';

changableVar = 'Prince';
// notChangableVar = 'Aurony'; 
// console.log(changableVar, notChangableVar);
...
function largeNameFriend (friend){

    let large = friend[0];

    for(let i = 0; i < friend.length; i++){
        if(large.length < friend[i].length){
            large = friend[i];
        }
    }
...
const friends = ['Hasib', 'Marzia', 'Anik', 'Mahi', 'Ferdous', 'Mahim', 'Tirtho'];
// console.log(largeNameFriend(friends));
...
const numbers = [1243, 34, 23, 3245, 312, 0, 43, 34, 21, 435, 34, -234, 43, 34, 43, 4234, 34 ];
